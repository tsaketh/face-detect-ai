...
const mapStateToProps = (state) => {
    return {
        ...
        errors: state.userSignUp.errors,
        user: state.userSignUp.user
    }
}
...
class Register extends Component{
    ...
    // }
    render(){
        const {onNameChange, nameError, onEmailChange, emailError, onPasswordChange, passwordError, onSignUp} = this.props;
        return(
