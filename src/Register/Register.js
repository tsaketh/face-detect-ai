...
class Register extends Component{
    ...
    render(){
        const {onNameChange, nameError, onEmailChange, emailError, onPasswordChange, passwordError, errors, isPending} = this.props;
        return(
            <div>
                ...
                <Loader isPending={isPending} message="Please wait while smart brain registers you inside of its neurons..!"/>:
            </div>
        )
    }
